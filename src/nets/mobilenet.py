...
class MobileNetV1(nn.Module):
    ...
    def __init__(self, dropout_keep_prob, embedding_size, pretrained):
        ...
        if pretrained:
            self.load_state_dict(torch.load(" /home/qiujing/cqwork/arcface-pytorch/model_data/mobilenet_v1_backbone_weights.pth"), strict = False)  
            # model_data/mobilenet_v1_backbone_weights.pth
        else:
